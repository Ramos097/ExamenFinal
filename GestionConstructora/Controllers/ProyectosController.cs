...
namespace GestionConstructora.Controllers
{
    public class ProyectosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodigoProyecto,NombreProyecto,FechaInicio,FechaFin")] Proyectos proyectos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodigoProyecto,NombreProyecto,FechaInicio,FechaFin")] Proyectos proyectos)
        {
            if (ModelState.IsValid)
            {
